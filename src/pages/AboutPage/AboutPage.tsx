...
const AboutPage = () => {
    return (
        <div className={styles.aboutPage}>
            ...
            <h2>👨‍💻 Разработчик:</h2>
            <p>
                Проект разработан студентом IT-факультета <strong>Нуртасом Сериккановым</strong><br />
                в рамках дипломной работы по теме:<br />
                <em>«Разработка платформы для анализа и визуализации городских обращений»</em>
            </p>
        </div>
    );
};
